...
AddParticleStream(10, 8, -8,  pi/3, 0, 0, 1);%left leg
AddParticleStream(10, 13, -15,  -pi/3, 0, 0, 1);%right
AddParticleStream(10, 8.5, -5.5, -pi / 2, 0, 0, 1);%body

AddCircAtomicArray(2.5, 4.5e-9, 4e-9, 0, 0, 0, 0, 0);%head
